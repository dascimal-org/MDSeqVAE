...
class RNNClassifier:
    def __init__(self, iPara):
        ...
        self.n_z = 4096
        self.OutName = 'txtLog/z4096_WU010_Lr0_0005VAESepWSKL101' + str(iPara) + '.txt'
    ...
    def _create_loss(self):
        ...
        self.lossVAE = 0.00025 * self.loss_prior_0_1 + 0.007 * self.loss_z_0 + 0.007 * self.loss_z_1 + 0.08 * self.reconstr_loss
        self.loss = 2.0 * self.loss_svm
