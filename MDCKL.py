...
class RNNClassifier:
    def __init__(self, iPara):
        ...
        self.wpz  = 0.0007
        self.wrecon = 0.008
        self.OutName = 'txtLog/z4096_KLC001_Lr0_0005VAE' + str(iPara) + '.txt'
    ...
    def _create_loss(self):
        ...
        self.loss = self.wsvm * self.loss_svm + self.wp01 * self.loss_prior_0_1 + self.wpz * (self.loss_z_0 + self.loss_z_1) + self.wrecon * self.reconstr_loss
